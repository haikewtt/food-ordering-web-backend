...
export const validateMyRestaurantRequest = [
    ...
    body("estimatedDeliveryTime").isInt({min: 0}).withMessage("Estimated time must be posivite"),
    ...
    body("menuItems.*.price").isFloat({min: 0}).withMessage("Menu item price is required and positive"),
    handleValidationErrors, 
];